...
public class EnhancedIoThreadPoolDemo {
    ...
    private static final ThreadFactory namedThreadFactory = new ThreadFactoryBuilder()
            .setNameFormat("public-io-denseness-thead-pool").build();
    private static final ExecutorService pool = new ThreadPoolExecutor((int) BigDecimalUtils.divideEx((double) AVAILABLE_PROCESSORS, BigDecimalUtils.subtract(1, BLOCKAGE_COEFFICIENT), BigDecimalUtils.ROUND_UP), 200,
